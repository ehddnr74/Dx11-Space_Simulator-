...
class HyperLoopScript_Uranus : public CScript
{
private:
    ...
    HyperLoopScript_Saturn* m_HyperLoop;
    ...
    bool HyperLoop_Neptune_MonsterSpawn = false;
...
public:
    ...
    void SetHyperLoopConnet(HyperLoopScript_Saturn* HLS) { m_HyperLoop = HLS; }

    bool GetSpawnCheck() { return HyperLoop_Neptune_MonsterSpawn; }

    CLONE(HyperLoopScript_Uranus);
public:
